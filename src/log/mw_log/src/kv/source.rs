...
mod std_support {
    ...
    mod tests {
        ...
        fn get() {
            ...
            assert_eq!(value::inner::Token::I64(1), Source::get(&source, Key::from_str("a")).unwrap().to_token());
        ...
        fn hash_map() {
            ...
            assert_eq!(value::inner::Token::I64(1), Source::get(&map, Key::from_str("a")).unwrap().to_token());
        }
